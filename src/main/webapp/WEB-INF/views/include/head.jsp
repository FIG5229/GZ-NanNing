...
<script src="${ctxStatic}/webuploader/webuploader.js" type="text/javascript"></script>
<link href="${ctxStatic}/webuploader/webuploader.css" rel="stylesheet" type="text/css" />
<link href="${ctxStatic}/common/jeesite.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/jeesite.js" type="text/javascript"></script>
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';</script>
<script src="${ctxStatic}/echart/echarts.min.js.js" type="text/javascript"></script>
<link href="${ctxStatic}/common/common.css" type="text/css" rel="stylesheet" />
<link href="${ctxStatic}/common/modal-custom.css" type="text/css" rel="stylesheet" />
<script type="text/javascript"  src="${ctxStatic}/js/export.js"></script>
<script src="${ctxStatic}/bootstrap/3.3.7/js/printThis.js" type="text/javascript"></script>