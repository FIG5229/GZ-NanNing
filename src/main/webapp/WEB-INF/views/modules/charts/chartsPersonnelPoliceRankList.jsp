...
<body>
	...
	<form:form id="searchForm" modelAttribute="personnelPoliceRank" action="${ctx}/personnel/personnelPoliceRank/chartsPoliceRankList" method="post" class="breadcrumb form-search">
					...
					<input id="label" name="label" type="hidden" value="${personnelPoliceRank.label}"/>
					<input id="unitId" name="unitId" type="hidden" value="${personnelPoliceRank.unitId}"/>
					<%--<ul class="ul-form">
						<li><label>起算日期：</label>
