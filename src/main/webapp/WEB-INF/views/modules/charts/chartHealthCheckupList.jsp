...
<body>
	...
	<form:form id="searchForm" modelAttribute="affairHealthCheckup" action="${ctx}/affair/affairHealthCheckup/healthReferenceDetail" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<input id="year" name="year" type="hidden" value="${affairHealthCheckup.year}"/>
		<input id="month" name="month" type="hidden" value="${affairHealthCheckup.month}"/>
		<input id="dateType" name="dateType" type="hidden" value="${affairHealthCheckup.dateType}"/>
		<input id="label" name="label" type="hidden" value="${affairHealthCheckup.label}"/>
		<input name="beginTjDate" type="hidden" readonly="readonly" maxlength="20" class="input-medium Wdate"
			   value="<fmt:formatDate value="${affairHealthCheckup.beginTjDate}" pattern="yyyy-MM-dd"/>"
			   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
		<input name="endTjDate" type="hidden" readonly="readonly" maxlength="20" class="input-medium Wdate"
