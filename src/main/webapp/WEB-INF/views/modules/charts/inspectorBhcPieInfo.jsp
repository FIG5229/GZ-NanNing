...
<script type="text/javascript">
    touSuPie();
    function touSuPie(){
        $.get('${ctx}/sys/charts/inspectorBhcPiePageInfo?flag=${flag}&id=${id}&dateType=${dateType}&year=${year}&dateStart=${startDate}&dateEnd=${endDate}&month=${month}', function(data){
            var labelData = [];
            var pieData = [];
            ...
            firstChart.on('click', function (params) {
                ...
                var url = "iframe:${ctx}/affair/affairDcwtLibrary/findBhcDetailInfoList?zgType="+zgType+"&flag=${flag}&id=${id}&dateType=${dateType}&year=${year}&dateStart=${startDate}&dateEnd=${endDate}&month=${month}";
