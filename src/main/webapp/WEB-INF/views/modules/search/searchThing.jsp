...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/search/searchThing">事务搜索</a></li>
    <!--
...
<br/>
<form id="inputForm" class="form-horizontal" action="${ctx}/search/formSearchThing">
    ...
    <div class="search-tag">
        <div class="search-tip active">为您找到相关搜索${requestScope.esThingPagerSearchResult.total}个</div>
    ...
    <div class="search-list">
        <c:forEach items="${requestScope.esThingPagerSearchResult.datas}" var="items">
            <div class="search-item">
                <div class="search-name">${items.thingMessage}</div>
                <div class="search-row">
                        <%--                    <div class="search-pic"><img src="../../../../politics/static/images/timg.jpg" alt=""></div>--%>
                    <div class="search-info">
                        <p class="search-text line1Hidden">事务类别：${items.thingMessage}</p>
                        <p class="search-text line1Hidden">关键词：${items.keyWord}</p>
                    </div>
                </div>
            </div>
        </c:forEach>
