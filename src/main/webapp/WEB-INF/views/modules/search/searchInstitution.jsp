...
<ul class="nav nav-tabs">
    ...
    -->
    <li class="active"><a href="${ctx}/search/searchInstitution">机构搜索</a></li>
    <li><a href="${ctx}/search/searchFile">文件搜索</a></li>
</ul>
<br/>
<form id="inputForm" class="form-horizontal" action="${ctx}/search/formSearchInstitution">
    ...
    <div class="search-tag">
        <div class="search-tip active">为您找到相关搜索${requestScope.officePagerSearchResult.total}个</div>
    ...
    <div class="search-list">
        <c:forEach items="${requestScope.officePagerSearchResult.datas}" var="items">
            <div class="search-item">
                <div class="search-name">${items.name}</div>
                <div class="search-row">
                    <div class="search-info">
                        <p class="search-text line1Hidden">机构名字：${items.name}</p>
                        <p class="search-text line1Hidden">机构简称：${items.abbreviation}</p>
                        <p class="search-text line1Hidden">机构全名：${items.fullName}</p>
                        <div>
                            <a href="">编制信息 </a>
                            <a href="">职数信息 </a>
                            <a href="">奖励信息 </a>
