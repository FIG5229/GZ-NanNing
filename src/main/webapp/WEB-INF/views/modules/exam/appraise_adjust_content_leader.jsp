                ...
                <div style="text-align: right;">审核人：<input type="text" name="fill_person" value="${fns:getUser().name}" disabled></br></br>
                    <c:choose>
                        <c:when test="${'7'.equals(nextStep)&& !'true'.equals(history)}">
                            ...
                            <input id="complete" class="btn btn-primary" type="button" value="结束并推送到" onclick="sendSubmit('groupAdjust','mainBureausSign')"   <c:if test="${'false'==isEdit}"> disabled="true" </c:if> />
                        ...
                        <c:otherwise>
                            ...
                            <input id="complete" class="btn btn-primary" type="button" value="结束并推送到" onclick="sendSubmit('mainBureausSignAll')"   <c:if test="${'false'==isEdit}"> disabled="true" </c:if> />
