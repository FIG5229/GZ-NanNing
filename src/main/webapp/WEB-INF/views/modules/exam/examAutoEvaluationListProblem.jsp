...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/exam/examAutoEvaluation/view">自动考评有效数据</a></li>
		<li class="active"><a href="${ctx}/exam/examAutoEvaluation/problem" style="color: red;">自动考评无效数据</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="examAutoEvaluation" action="${ctx}/exam/examAutoEvaluation/problem" method="post" class="breadcrumb form-search">
