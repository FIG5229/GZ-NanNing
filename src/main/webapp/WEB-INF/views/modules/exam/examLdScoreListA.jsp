...
<head>
	...
	<script type="text/javascript">
        ...
        function openAddDialog(url) {
			top.$.jBox.open("iframe:"+url, "评定优秀",800,520,{
				buttons:{"关闭":true},
				loaded:function(){
					$(".jbox-content", top.document).css("overflow-y","hidden");
				},closed:function (){self.location.href="${ctx}/exam/examLdScore/list?grades=5&workflowId=${workflowId}"}
			});
		}
...
<body>
	...
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/exam/examLdScore/list?grades=3&workflowId=${workflowId}">基本达标</a></li>
		<li><a href="${ctx}/exam/examLdScore/list?grades=2&workflowId=${workflowId}">不达标</a></li>
		<li class="active"><a href="${ctx}/exam/examLdScore/list?grades=5&workflowId=${workflowId}">优秀</a></li>
		<li><a href="${ctx}/exam/examLdScore/list?grades=4&workflowId=${workflowId}">达标</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="examLdScore" action="${ctx}/exam/examLdScore/list?grades=5" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="btnAdd" class="btn btn-primary" type="button" value="添加" onclick="openAddDialog('${ctx}/exam/examLdScore/formExcellent?grades=4')"/></li>
