...
<%--	</ul>--%>
<br/>
	<form:form id="inputForm" modelAttribute="examLdScoreMonth" action="${ctx}/exam/examLdScoreMonth/saveBeta" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${examLdScoreMonth.unitId}" labelName="unit" labelValue="${examLdScoreMonth.unit}"
								title="单位" url="/sys/office/treeData?type=2" cssClass="required" allowClear="true" notAllowSelectParent="false" dataMsgRequired="必填信息" disabled="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="score" htmlEscape="false" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">事项：</label>
			<div class="controls">
				<form:input path="matter" htmlEscape="false" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
