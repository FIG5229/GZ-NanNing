    ...
    <div class="">
        <div class="modal-custom-main">
            ...
            <div class="modal-custom-bar" id="tabs">
                ...
                <div><input id="check" class="btn btn-primary" type="button" value="检查情况" onclick=""/>&nbsp;&nbsp;&nbsp;&nbsp;<input id="reward" class="btn btn-primary" type="button" value="奖惩情况" onclick=""/>&nbsp;&nbsp;&nbsp;&nbsp;<input id="back" class="btn btn-primary" type="button" value="返回" onclick="back()"/></div>
            </div>
