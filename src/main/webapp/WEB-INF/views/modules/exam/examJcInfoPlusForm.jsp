...
<body>
<br/>
<form:form id="inputForm" modelAttribute="examJcInfo" action="${ctx}/exam/examJcInfoPlus/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    <form:hidden path="pushNum"/>
    ...
    <div class="control-group">
        <label class="control-label">奖励文号：</label>
        <div class="controls">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="jcOrg" name="jcOrgId" value="${examJcInfo.jcOrgId}" labelName="jcOrg" labelValue="${examJcInfo.jcOrg}"
