...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/exam/examSystemDisplay/">系统公示列表</a></li>
		<li class="active"><a href="${ctx}/exam/examSystemDisplay/form?id=${examSystemDisplay.id}">系统公示<shiro:hasPermission name="exam:examSystemDisplay:edit">${not empty examSystemDisplay.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="exam:examSystemDisplay:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="examSystemDisplay" action="${ctx}/exam/examSystemDisplay/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="exam:examSystemDisplay:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
