    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="time" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
                   value="<fmt:formatDate value="${examAutoEvaluation.time}" pattern="yyyy-MM-dd"/>"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="unit" name="unitId" value="${examAutoEvaluation.unitId}" labelName="unit" labelValue="${examAutoEvaluation.unit}"
                            title="部门" url="/sys/office/treeData?type=2" cssClass="required" allowClear="true" notAllowSelectParent="true" checked="true" dataMsgRequired="必填信息"/>
            <font color="red">*</font>
        </div>
    </div>
    <div class="control-group">
