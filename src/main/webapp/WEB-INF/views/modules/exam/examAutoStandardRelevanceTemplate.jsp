...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="examAutoStandardRelevance" action="${ctx}/exam/examAutoStandardRelevance/templateSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="item" htmlEscape="false" class="input-xlarge  required" readonly="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="evealType" class="input-xlarge required" onchange="getChooseStandardList();getChooseStandardListnew()" disabled="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="period" class="input-xlarge required" disabled="true">
					<form:option value="" label=""/>
		...
		<div class="control-group" id="suoshuC">
			...
			<div class="controls">
				<form:select path="chuId" class="input-xlarge required" disabled="true">
					<form:option value="" label=""/>
		...
		<div class="control-group">
			<label class="control-label">使用模板：</label>
			<div class="controls">
				<%--<form:select path="modelId" class="input-xlarge required" onchange="getChooseOptionsList()" disabled="true">
					<form:option value="" label="请先选择考评类别"/>
				</form:select>--%>
					<form:input path="model" htmlEscape="false" class="input-xlarge  required" readonly="true"/>
					<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<%--<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">选择项：</label>
			<div class="controls">
				<%--<form:select path="optionId" class="input-xlarge required" disabled="true">
					<form:option value="" label="请先选择模板"/>
				</form:select>--%>
					<form:input path="option" htmlEscape="false" class="input-xlarge  required" readonly="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
