...
<body>
<form:form id="inputForm" modelAttribute="personnelEndowmentInsurance" action="${ctx}/personnel/personnelEndowmentInsurance/generate" method="post" class="form-horizontal">
    <form:hidden path="id"/>
