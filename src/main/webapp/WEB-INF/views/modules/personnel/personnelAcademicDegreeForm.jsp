...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="personnelAcademicDegree" action="${ctx}/personnel/personnelAcademicDegree/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<c:choose>
			<c:when test="${personnelAcademicDegree.idNumber == null}">
		...
		<div class="control-group">
			<label class="control-label">授予日期：</label>
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${personnelAcademicDegree.date}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			<label class="control-label">授予国家：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">最高学位说明：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">多学位序号：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">学位名称代码：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="personnel:personnelAcademicDegree:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
