...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="personnelLanguage" action="${ctx}/personnel/personnelLanguage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<c:choose>
			<c:when test="${personnelLanguage.idNumber == null}">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="degree" class="input-xlarge required">
		...
		<div class="form-actions">
			<shiro:hasPermission name="personnel:personnelLanguage:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
