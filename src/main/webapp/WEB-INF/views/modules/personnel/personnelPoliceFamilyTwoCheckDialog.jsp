...
<body>
<form:form id="inputForm" modelAttribute="personnelPoliceFamilyTwo" action="${ctx}/personnel/personnelPoliceFamilyTwo/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
    ...
    <div class="controls" type="hidden">
        ...
        <%--<sys:treeselect id="juCheckMan" name="juCheckId" value="${affairActivityMien.juCheckId}" labelName="juCheckMan" labelValue="${affairActivityMien.juCheckMan}"
