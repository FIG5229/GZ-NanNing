...
<table id="contentTable" class="table table-bordered" style="width: 90%;margin: auto;text-align: center">
	<tr>
		...
		<td colspan="3" class="td75">${warnHistory.warnName}</td>
	</tr>
	<tr>
		<td class="td25">接受用户</td>
		<td colspan="3" class="td75">${warnHistory.receivePerName}</td>
	</tr>
	<tr>
		<td class="td25">重复周期</td>
		<td colspan="3" class="td75">${fns:getDictLabel(warnHistory.repeatCycle, 'warn_repeat_cycle', '')}</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" class="td75">
			${fns:getDictLabel(warnHistory.remind, 'warn_remind','')}
				<br>
			<span><font color="red">*注意：${fns:getDictLabel(warnHistory.remind, 'warn_remind','')}，表示正常情况下每${fns:getDictLabel(warnHistory.remind, 'warn_remind','')}提醒一次</font> </span>
		</td>
	</tr>
	<tr>
		<td class="td25">持续时间</td>
		<td colspan="3" class="td75">${warnHistory.continueDay}天</td>
	</tr>
	<tr>
		<td class="td25">弹窗内容</td>
		<td colspan="3" class="td75">${warnHistory.alertContent}</td>
	</tr>
	<tr>
		<td class="td25">紧急程度</td>
		<td colspan="3" class="td75">${fns:getDictLabel(warnHistory.alertDegree, 'warn_degree', '')}</td>
	</tr>
</table>
<br>
