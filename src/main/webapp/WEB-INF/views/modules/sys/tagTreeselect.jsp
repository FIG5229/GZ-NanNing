...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:false,chkboxType :{ "Y" : "s", "N" : "s" },chkStyle:"checkbox"},
				async:{enable:(type==3),url:"${ctx}${getUserUrl}",autoParam:["id=officeId"],otherParam : [{"examTreeType":"${examTreeType}"}]},
