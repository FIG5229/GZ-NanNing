...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">实际部门:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="baseOffice" name="baseOfficeId" value="${user.baseOfficeId}" labelName="baseOfficeName" labelValue="${user.baseOfficeName}"
					title="部门" url="/sys/office/treeData?type=2" cssClass="required" notAllowSelectParent="false"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				--%>
				<form:select path="roleIdList" class="input-xlarge required" multiple="true" cssStyle="width: 500px;">
