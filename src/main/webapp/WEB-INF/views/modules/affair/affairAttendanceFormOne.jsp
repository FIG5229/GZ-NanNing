...
<body>
<br/>
<form:form id="inputForm" modelAttribute="affairAttendance" action="${ctx}/affair/affairAttendance/saveOne?idNumber=${idNumber}" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="year" htmlEscape="false" class="input-xlarge number required" readonly="true"/>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="mouth" htmlEscape="false" class="input-xlarge number required" readonly="true"/>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    </div>
    <div class="control-group">
                ...
                <shiro:hasPermission name="affair:affairAttendance:edit">
                    ...
                    <tr>
                        <td colspan="46"><a href="javascript:"
                                            onclick="addRow('#affairAttendanceChildList', affairAttendanceChildRowIdx, affairAttendanceChildTpl);affairAttendanceChildRowIdx = affairAttendanceChildRowIdx + 1;"
                                            class="btn">新增</a></td>
                    </tr>
                    </tfoot>
                </shiro:hasPermission>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        addRow('#affairAttendanceChildList', affairAttendanceChildRowIdx, affairAttendanceChildTpl, data[i]);
