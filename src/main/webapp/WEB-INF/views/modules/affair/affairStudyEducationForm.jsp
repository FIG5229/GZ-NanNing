...
<%--		<li><a href="${ctx}/affair/affairStudyEducation/">学习教育列表</a></li>--%>
		<%--<li class="active"><a href="${ctx}/affair/affairStudyEducation/form?id=${affairStudyEducation.id}">学习教育<shiro:hasPermission name="affair:affairStudyEducation:edit">${not empty affairStudyEducation.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="affair:affairStudyEducation:edit">查看</shiro:lacksPermission></a></li>--%>
	<br/>
	<form:form id="inputForm" modelAttribute="affairStudyEducation" action="${ctx}/affair/affairStudyEducation/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="niandu" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairStudyEducation.date}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="ydNum" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sdNum" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="filePath" type="files" uploadPath="affair/affairStudyEducation" selectMultiple="true"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairStudyEducation:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
