...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairBaseSkill" action="${ctx}/affair/affairBaseSkill/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">项目七：</label>
			<div class="controls">
				<form:input path="itemSeven" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">项目八：</label>
			<div class="controls">
				<form:input path="itemEight" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">项目九：</label>
			<div class="controls">
				<form:input path="itemNine" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">项目十：</label>
			<div class="controls">
				<form:input path="itemTen" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
...
<%--				<form:input path="assessment" htmlEscape="false" class="input-xlarge "/>--%>
				<form:select path="assessment" class="input-xlarge ">
					<form:option value="" label=""/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairBaseSkill:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
