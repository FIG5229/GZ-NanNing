...
<body>
<form:form id="inputForm" modelAttribute="affairRewardDeclaration" action="${ctx}/affair/affairRewardDeclaration/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
    ...
    <div class="controls">
        ...
        <sys:treeselect id="juCheckMan" name="juCheckId" value="${affairRewardDeclaration.juCheckId}" labelName="juCheckMan" labelValue="${affairRewardDeclaration.juCheckMan}"
