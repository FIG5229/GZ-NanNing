...
<body>
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/saves?type=affairTnActivityRecord" method="post" class="form-horizontal">
		<%--<form:hidden path="id"/--%>
		<input name="affairTnActivityRecordId" value="${affairTnActivityRecordId}" type="hidden">
...
<%--后台规定为2
		...
		<div class="form-actions">
			<shiro:hasPermission name="cms:article:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"
