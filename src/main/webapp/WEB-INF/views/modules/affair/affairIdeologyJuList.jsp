...
<ul class="nav nav-tabs">
    <c:choose>
        <c:when test="${userId=='66937439b2124f328d1521968fab06db' || userId == '8a6819768aef40968e8f289842613276'} ">
            <li class="active"><a href="${ctx}/affair/affairIdeology/juList">局机关</a></li>
            <li><a href="${ctx}/affair/affairIdeology/manage">公安处党委</a></li>
        </c:when>
        <c:when test="${userId == 'e3ac8381fb3247e0b64fd6e3c48bddc1' || userId=='d30e324c8f73492d9b74103374fbc689'|| userId=='d154234ecb35470e84fb95e53726866b'}">
            <li><a href="${ctx}/affair/affairIdeology/manage">基层党支部</a></li>
            <li class="active"><a href="${ctx}/affair/affairIdeology/list">公安处党委</a></li>
        </c:when>
        <c:otherwise>
            <%--其他账号进行上报--%>
            <li class="active"><a href="${ctx}/affair/affairIdeology/list">基层党支部</a></li>
        </c:otherwise>
    </c:choose>
...
<form:form id="searchForm" modelAttribute="affairIdeology" action="${ctx}/affair/affairIdeology/list?flag=1" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="affairIdeology" varStatus="status">
        <tr>
            ...
            <td>
                    ${fns:getDictLabel(affairIdeology.reportType, 'report_type', '')}
            </td>
                <%--				<td>--%>
