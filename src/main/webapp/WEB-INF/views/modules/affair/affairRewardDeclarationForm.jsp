...
<body>
<br/>
	<form:form id="inputForm" modelAttribute="affairRewardDeclaration" action="${ctx}/affair/affairRewardDeclaration/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairRewardDeclaration.date}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="mianmao" class="input-xlarge required">
					<form:option value="" label=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:treeselect id="approvalUnit" name="approvalUnitId" value="${affairRewardDeclaration.approvalUnitId}" labelName="approvalUnit" labelValue="${affairRewardDeclaration.approvalUnit}"
								title="单位" url="/sys/office/treeData?type=3"  allowClear="true" notAllowSelectParent="false" isAll="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">奖励名称：</label>
			<div class="controls">
				<form:input path="rewardName" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
...
<%--					再次更改<form:options items="${fns:getDictList('affair_approval_unitLevel')}" itemLabel="label" itemValue="value" htmlEscape="false"/>--%>
<%--					更改为统一字典<form:options items="${fns:getDictList('affair_grsb_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>--%>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="filePath" type="files" uploadPath="affair/affairRewardDeclaration" selectMultiple="true"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairRewardDeclaration:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
