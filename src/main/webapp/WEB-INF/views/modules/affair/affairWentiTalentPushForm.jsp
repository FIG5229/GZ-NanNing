...
<body>
<br/>
<form:form id="inputForm" modelAttribute="affairWentiTalent" action="${ctx}/affair/affairWentiTalent/save" method="post" class="form-horizontal">
    <sys:message content="${message}"/>
    <input id="flag" name="flag" type="hidden" value="false"/>
    <input id="name" name="name" type="hidden" value="${affairWentiTalent.name}"/>
    <input id="idNumber" name="idNumber" type="hidden" value="${affairWentiTalent.idNumber}"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input id="birthday"  name="birthday" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
                   value="<fmt:formatDate value="${affairWentiTalent.birthday}" pattern="yyyy-MM-dd"/>"
    ...
    <div class="form-actions">
        <shiro:hasPermission name="affair:affairWentiTalent:edit"><input id="btnSubmit" class="btn btn-primary" type="button" value="保 存" onclick="save()"/>&nbsp;</shiro:hasPermission>
