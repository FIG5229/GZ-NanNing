...
<head>
	...
	<script type="text/javascript">
		...
		function openDetailDialog(id,signStatus) {
			...
			top.$.jBox.open(url, "纪检监察通知通报",1000,600,{
				buttons:{"关闭":true},
				loaded:function(h){
					$(".jbox-content", top.document).css("overflow-y","hidden");
				},closed:function (){
					self.location.href="${ctx}/affair/affairFileNotice?flag=7";
				}
			});
		};
	</script>
...
<ul class="nav nav-tabs">
	<li class="active"><a href="${ctx}/affair/affairFileNotice?flag=7">查询</a></li>
	<shiro:hasPermission name="affair:affairFileNotice:manage7"><li><a href="${ctx}/affair/affairFileNotice/manageList?flag=7">管理</a></li></shiro:hasPermission>
</ul>
...
<form:form id="searchForm" modelAttribute="affairFileNotice" action="${ctx}/affair/affairFileNotice/" method="post" class="breadcrumb form-search">
	...
	<ul class="ul-form">
		...
		<li class="btns"><input  class="btn btn-primary" type="button" value="重置" onclick="window.location.href='${ctx}/affair/affairFileNotice?flag=7'"/></li>
