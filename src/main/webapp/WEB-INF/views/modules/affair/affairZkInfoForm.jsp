...
<%--		<li><a href="${ctx}/affair/affairZkInfo/">助困管理列表</a></li>--%>
		<%--<li class="active"><a href="${ctx}/affair/affairZkInfo/form?id=${affairZkInfo.id}">助困管理<shiro:hasPermission name="affair:affairZkInfo:edit">${not empty affairZkInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="affair:affairZkInfo:edit">查看</shiro:lacksPermission></a></li>--%>
	<br/>
	<form:form id="inputForm" modelAttribute="affairZkInfo" action="${ctx}/affair/affairZkInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairZkInfo.date}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="subsidyOrg" class="input-xlarge required">
					<form:option value="" label=""/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairZkInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
