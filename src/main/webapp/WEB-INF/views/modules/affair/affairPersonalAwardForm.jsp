...
<body>
    <br>
	<form:form id="inputForm" modelAttribute="affairPersonalAward" action="${ctx}/affair/affairPersonalAward/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairPersonalAward.date}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<%--10-7问题反馈
				表彰奖励—个人—添加：选择单位时，单位账号下不需要显示个人账号。--%>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input id="name" path="policeName" htmlEscape="false" class="input-xlarge required" onkeydown="if(event.keyCode==13){setDefaults();return false;}"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input id="job" path="job" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
...
<%--		<div class="control-group">
			<label class="control-label">颁发单位：</label>
			<div class="controls">
				<sys:treeselect id="bzUnit" name="bzUnitId" value="${affairPersonalAward.bzUnitId}" labelName="bzUnit" labelValue="${affairPersonalAward.bzUnit}"
...
<%--				<span class="help-inline"><font color="red">*</font> </span>--%>
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairPersonalAward:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
