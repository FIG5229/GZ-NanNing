		...
		<div class="modal-custom-main">
			<div id="contentTable" class="modal-custom-content">
				<div class="modal-custom-info1">
					<p style="color:#555555;font-size:14px;text-align:left;border-bottom:1px solid #ddd;padding-bottom:15px;margin:25px 0;">发布部门：${affairPolicewomanWork.publishDep}</p>
					${affairPolicewomanWork.content}
				</div>
