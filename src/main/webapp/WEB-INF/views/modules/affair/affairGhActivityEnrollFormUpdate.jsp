...
<body>
<br/>
	<form:form id="inputForm" modelAttribute="affairGhActivityEnroll" action="${ctx}/affair/affairGhActivityEnroll/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
