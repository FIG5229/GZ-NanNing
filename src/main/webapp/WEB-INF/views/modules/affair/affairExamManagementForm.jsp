...
<body>
<br/>
	<form:form id="inputForm" modelAttribute="affairExamManagement" action="${ctx}/affair/affairExamManagement/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">参加考试时间：</label>
			<div class="controls">
				<input name="joinDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${affairExamManagement.joinDate}" pattern="yyyy-MM-dd"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairExamManagement:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
