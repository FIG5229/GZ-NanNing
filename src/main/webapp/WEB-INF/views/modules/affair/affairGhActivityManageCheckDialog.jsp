...
<body>
<form:form id="inputForm" modelAttribute="affairGhActivityManage" action="${ctx}/affair/affairGhActivityManage/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
