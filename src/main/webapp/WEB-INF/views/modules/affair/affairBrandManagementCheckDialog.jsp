...
<body>
<form:form id="inputForm" modelAttribute="affairBrandManagement" action="${ctx}/affair/affairBrandManagement/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
    ...
    <c:choose>
        <c:when test="${fns:getUser().id eq '11d94fe57ede47a9bae4bffa36af487c' || fns:getUser().id eq '28f59642a1e74d0588f0d515fe462775' || fns:getUser().id eq '78d0e07ed2e14ca0b6c73e14c11f4d55'}">
            <div class="control-group">
        ...
        <c:when test="${fns:getUser().id eq 'ff7f9fe2597b40429ded58f8b76a2f65'}">
            <div class="control-group">
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <div style="margin-left: 500px;margin-top: 70px;">
                <input id="btnSubmit3" class="btn btn-primary" type="button" value="通过并结束" onclick="setCheckType(4)"/>&nbsp;
                <input id="btnSubmit4" class="btn btn-primary" type="button" value="不通过" onclick="setCheckType(0)"/>&nbsp;
            </div>
        </c:otherwise>
    </c:choose>
</form:form>
