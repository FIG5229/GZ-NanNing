...
<body>
	 <br/>
	<form:form id="inputForm" modelAttribute="affairNetworkCollege" action="${ctx}/affair/affairNetworkCollege/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="thisMonthIntegral" htmlEscape="false" class="input-xlarge numbere required" />
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="adjunct" type="files" uploadPath="affair/affairNetworkCollege" selectMultiple="true"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairNetworkCollege:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
