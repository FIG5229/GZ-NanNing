...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairCertificateIssue" action="${ctx}/affair/affairCertificateIssue/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairCertificateIssue:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
