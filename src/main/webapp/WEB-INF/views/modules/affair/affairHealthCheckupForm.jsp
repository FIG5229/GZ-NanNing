...
<body><%--
	...
	<br/>
	<form:form id="inputForm" modelAttribute="affairHealthCheckup" action="${ctx}/affair/affairHealthCheckup/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="tjDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairHealthCheckup.tjDate}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="age" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">患病史：</label>
			<div class="controls">
				<form:select path="type" class="input-xlarge "  multiple="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea id="tjQingkuang" htmlEscape="true" path="tjQingkuang" rows="4" class="input-xxlarge"/>
			</div>
		</div>
		<%--<div class="control-group">
			<label class="control-label">复检原因：</label>
			<div class="controls">
				<form:input path="fjReason" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>--%>
		<div class="control-group">
			<label class="control-label">复检原因：</label>
			<div class="controls">
				<form:textarea id="fjReason" htmlEscape="true" path="fjReason" rows="4" class="input-xxlarge"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairHealthCheckup:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
