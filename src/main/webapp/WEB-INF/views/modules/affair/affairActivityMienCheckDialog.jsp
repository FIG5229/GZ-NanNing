...
<body>
<form:form id="inputForm" modelAttribute="affairActivityMien" action="${ctx}/affair/affairActivityMien/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
