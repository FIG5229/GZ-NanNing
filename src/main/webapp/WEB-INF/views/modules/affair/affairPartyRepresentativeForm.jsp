...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairPartyRepresentative" action="${ctx}/affair/affairPartyRepresentative/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${affairPartyRepresentative.unitId}" labelName="unit" labelValue="${affairPartyRepresentative.unit}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairPartyRepresentative:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
