...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairChuPartyCongressRepresentative" action="${ctx}/affair/affairChuPartyCongressRepresentative/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${affairChuPartyCongressRepresentative.unitId}" labelName="unit" labelValue="${affairChuPartyCongressRepresentative.unit}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairChuPartyCongressRepresentative:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
