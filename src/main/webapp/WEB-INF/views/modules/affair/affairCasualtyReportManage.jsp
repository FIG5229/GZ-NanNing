...
//导出功能的JS
        ...
        function openDialog(id) {
            top.$.jBox.open("iframe:${ctx}/affair/affairCasualtyReport/Dialog?id="+id, "干部年度审核",800,420,{
                buttons:{"关闭":true},
                loaded:function(){
                    $(".jbox-content", top.document).css("overflow-y","hidden");
                },closed:function (){
                    self.location.href="${ctx}/affair/affairCasualtyReport/manageList";
                }
            });
        }
        //详情弹窗
...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="affair:affairCasualtyReport:manage"><li class="active"><a href="${ctx}/affair/affairCasualtyReport/manageList">抚恤审核</a></li></shiro:hasPermission>
...
<form:form id="searchForm" modelAttribute="affairCasualtyReport" action="${ctx}/affair/affairCasualtyReport/manageList" method="post" class="breadcrumb form-search">
    ...
    <ul class="ul-form">
        ...
        <li class="btns"><input  class="btn btn-primary" type="button" value="重置" onclick="window.location.href='${ctx}/affair/affairCasualtyReport/manageList'"/></li>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        <th>负伤程度</th>
        <th>审核状态</th>
        <shiro:hasPermission name="affair:affairCasualtyReport:manage"><th>操作</th></shiro:hasPermission>
    </tr>
    </thead>
    <tbody>
    <c:forEach items="${page.list}" var="affairCasualtyReport" varStatus="status">
        <tr>
            ...
            <shiro:hasPermission name="affair:affairCasualtyReport:manage"><td>
                <a onclick="openDialog('${affairCasualtyReport.id}')">审核</a>
