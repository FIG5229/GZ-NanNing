                    ...
                    <div class="modal-custom-info2">
                        <div class="modal-custom-info2-col modal-custom-info2-col1">
                            <div class="modal-custom-info2-row">
                                ...
                                <span class="modal-custom-info2-value">${affairAdvancedPerson.year}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-custom-info2">
                        <div class="modal-custom-info2-col modal-custom-info2-col1">
                            <div class="modal-custom-info2-row">
                                ...
                                <span class="modal-custom-info2-value">${affairAdvancedPerson.name}</span>
                            </div>
                        </div>
                    </div>
                    <div class="modal-custom-info2">
                        <div class="modal-custom-info2-col modal-custom-info2-col1">
                            <div class="modal-custom-info2-row">
                                <span class="modal-custom-info2-key">读书心得：</span>
                                <span class="modal-custom-info2-value">${affairAdvancedPerson.description}</span>
                            </div>
                        </div>
                    </div>
                </div>
