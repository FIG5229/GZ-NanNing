...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/affair/affairOtherPartyRepresentative/list?treeId=${treeId}">其他党代会代表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="affairOtherPartyRepresentative" action="${ctx}/affair/affairOtherPartyRepresentative/" method="post" class="breadcrumb form-search">
...
<%--		<ul class="ul-form2">--%>
			...
			<shiro:hasPermission name="affair:affairOtherPartyRepresentative:edit">
				<li class="btns"><input  class="btn btn-primary"  type="button" value="添加"
										 onclick="openForm('${ctx}/affair/affairOtherPartyRepresentative/form')"/></li>
				<li class="btns"><input id="del" class="btn btn-primary" type="button" value="删除"
										onclick="deleteByIds('${ctx}/affair/affairOtherPartyRepresentative/deleteByIds','checkAll','myCheckBox')"/></li>
				<li class="btns"><input  id="btnImport" class="btn btn-primary" type="button" value="导入" /></li>
			</shiro:hasPermission>
			<li class="btns"><input  id="btnExport" class="btn btn-primary" type="button" value="导出" /></li>
			<li class="btns"><input id="print" class="btn btn-primary" type="button" value="打印"/></li>
			<li class="btns"><input  class="btn btn-primary" type="button" value="重置"
									 onclick="window.location.href='${ctx}/affair/affairOtherPartyRepresentative/list?treeId=${treeId}'"/></li>
