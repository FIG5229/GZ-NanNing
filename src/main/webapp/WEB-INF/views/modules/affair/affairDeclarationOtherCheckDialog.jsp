...
<body>
<form:form id="inputForm" modelAttribute="affairDeclarationOther" action="${ctx}/affair/affairDeclarationOther/examine" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
