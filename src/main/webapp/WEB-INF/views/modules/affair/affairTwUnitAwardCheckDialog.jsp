...
<body>
<form:form id="inputForm" modelAttribute="affairTwUnitAward" action="${ctx}/affair/affairTwUnitAward/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
