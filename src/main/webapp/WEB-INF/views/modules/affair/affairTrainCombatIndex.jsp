...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="affair:affairTrainCombat:view"><li class="active"><a href="${ctx}/affair/affairTrainCombat/">实弹训练</a></li></shiro:hasPermission>
...
<script type="text/javascript">
	var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
		callback:{onClick:function(event, treeId, treeNode){
				...
				$('#officeContent').attr("src","${ctx}/affair/affairTrainCombat/list?organizationId="+treeNode.id+"&organization="+treeNode.name);
			}
		}
	};
