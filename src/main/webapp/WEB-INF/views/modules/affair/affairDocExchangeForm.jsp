...
<form:form id="inputForm" modelAttribute="affairFileNotice" action="${ctx}/affair/affairFileNotice/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="receiveDep" name="receiveDepId" value="${affairFileNotice.receiveDepId}" labelName="receiveDep" labelValue="${affairFileNotice.receiveDep}"
                title="接收部门" url="/sys/office/treeData?type=2" cssClass="required" allowClear="true" notAllowSelectParent="true" checked="true" dataMsgRequired="必填信息"/>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    </div>
    <c:if test="${flag == 5}"><%--5：绩效的通知通报  6：绩效的公文交换--%>
        <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:textarea id="content" htmlEscape="true" path="content" rows="4" class="input-medium"/>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="affair:affairFileNotice:manage5">
            <%-- 一旦发布不可再操作--%>
