...
<body>
	 <br/>
	<form:form id="inputForm" modelAttribute="affairWorkLead" action="${ctx}/affair/affairWorkLead/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">党组织名称：</label>
			<div class="controls">
				<sys:treeselect id="partyOrganization" name="partyOrganizationId" value="${affairWorkLead.partyOrganizationId}" labelName="partyOrganization" labelValue="${affairWorkLead.partyOrganization}"
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="adjunct" type="files" uploadPath="affair/affairWorkLead" selectMultiple="true"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairWorkLead:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
