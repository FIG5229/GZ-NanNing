...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairDeath" action="${ctx}/affair/affairDeath/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${affairDeath.unitId}" labelName="unit" labelValue="${affairDeath.unit}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="outDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${affairDeath.outDate}" pattern="yyyy-MM-dd"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairDeath:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
