...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/affair/affairLeaderCheck">领导干部年度考核</a></li>
	<%--	<shiro:hasPermission name="affair:affairLeaderCheck:manage"><li ><a href="${ctx}/affair/affairLeaderCheck/manageList">领导干部年度考核(审核)</a></li></shiro:hasPermission>
	--%></ul>
	<form:form id="searchForm" modelAttribute="affairLeaderCheck" action="${ctx}/affair/affairLeaderCheck/" method="post" class="breadcrumb form-search">
