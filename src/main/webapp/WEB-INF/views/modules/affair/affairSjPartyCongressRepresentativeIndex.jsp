...
<script type="text/javascript">
    var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:''}},
        callback:{onClick:function(event, treeId, treeNode){
                ...
                $('#officeContent').attr("src","${ctx}/affair/affairSjPartyCongressRepresentative/list?treeId="+id+"&isTree=1");
                /*treeId 参数加上treeNode.pId 导致查询时找不到相应的党组织Id 注释掉不用*/
                <!--$('#officeContent').attr("src","${ctx}/affair/affairSjPartyCongressRepresentative/list?treeId="+id+treeNode.pId+"&isTree=1");-->
            }
        }
    };
