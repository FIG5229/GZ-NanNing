...
<body>
<form:form id="inputForm" modelAttribute="affairDifficultHelp" action="${ctx}/affair/affairDifficultHelp/examine" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
