...
<body>
	 <br/>
	<form:form id="inputForm" modelAttribute="affairAdminStatistics" action="${ctx}/affair/affairAdminStatistics/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">管理范围，管理权限：</label>
			<div class="controls">
