...
<%--		<li><a href="${ctx}/affair/affairTixieActivityStyle/">活动风采列表</a></li>--%>
		<%--<li class="active"><a href="${ctx}/affair/affairTixieActivityStyle/form?id=${affairTixieActivityStyle.id}">活动风采<shiro:hasPermission name="affair:affairTixieActivityStyle:edit">${not empty affairTixieActivityStyle.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="affair:affairTixieActivityStyle:edit">查看</shiro:lacksPermission></a></li>--%>
	<br/>
	<form:form id="inputForm" modelAttribute="affairTixieActivityStyle" action="${ctx}/affair/affairTixieActivityStyle/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="releaseTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					   value="<fmt:formatDate value="${affairTixieActivityStyle.releaseTime}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="annex" type="files" uploadPath="affair/affairTixieActivityStyle" selectMultiple="true"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairTixieActivityStyle:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
