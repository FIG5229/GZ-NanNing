...
<body>
<form:form id="inputForm" modelAttribute="affairEducationComment" action="${ctx}/affair/affairEducationComment/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
        <label class="control-label" style="margin-top: 20px">处团委意见：</label>
        ...
        <form:textarea path="remark" htmlEscape="false" rows="3" class="input-xxlarge"  cssStyle="width: 300px"/>
    </div>
