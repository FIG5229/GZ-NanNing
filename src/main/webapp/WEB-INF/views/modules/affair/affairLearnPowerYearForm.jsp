...
<body>
	<form:form id="inputForm" modelAttribute="affairLearnPowerYear" action="${ctx}/affair/affairLearnPowerYear/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="time" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${affairLearnPowerYear.time}" pattern="yyyy"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairLearnPowerYear:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
