...
<head>
    ...
    function openDetailDialog(id,signStatus,flag) {
        ...
        top.$.jBox.open(url, "公文交换",1000,600,{
            buttons:{"关闭":true},
            loaded:function(h){
                $(".jbox-content", top.document).css("overflow-y","hidden");
            },closed:function (){
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/affair/affairFileNotice?flag=6">查询</a></li>
		...
		<shiro:hasPermission name="affair:affairFileNotice:manage6"><li><a href="${ctx}/affair/affairFileNotice/manageList?flag=6">管理</a></li></shiro:hasPermission>
	</ul>
	...
	<form:form id="searchForm" modelAttribute="affairFileNotice" action="${ctx}/affair/affairFileNotice/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form2">
			...
			<li class="btns"><input  class="btn btn-primary" type="button" value="重置" onclick="window.location.href='${ctx}/affair/affairFileNotice?flag=6'"/></li>
