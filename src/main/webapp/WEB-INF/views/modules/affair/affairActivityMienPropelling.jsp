...
<body>
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/saves?type=affairActivityMien" method="post" class="form-horizontal">
		<%--<form:hidden path="id"/--%>
