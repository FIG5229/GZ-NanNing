...
<body>
	<br>
	<form:form id="inputForm" modelAttribute="affairMjxyReport" action="${ctx}/affair/affairMjxyReport/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:choose>
			<c:when test="${affairMjxyReport.idNumber == null}">
				<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="startDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairMjxyReport.startDate}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="endDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairMjxyReport.endDate}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<%--<div class="control-group">
			<label class="control-label">是否携带家属：</label>
			<div class="controls">
				<form:select path="isFamily" class="input-xlarge required">
					<form:option value="" label=""/>
		...
		<div class="control-group">
			<label class="control-label">免票号：</label>
			<div class="controls">
				<form:input path="freeTicketNo" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="contactMethod" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairMjxyReport:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
