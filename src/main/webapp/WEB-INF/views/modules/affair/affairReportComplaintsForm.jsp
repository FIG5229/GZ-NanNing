...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairReportComplaints" action="${ctx}/affair/affairReportComplaints/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:choose>
			<c:when test="${fns:getUser().id eq 'ca32723864644fa8979693dc9a539b91' || fns:getUser().id eq '1fdedc31fd6944eb8cbb9a279f4cb3c4' ||
				...
				<div class="control-group">
					...
					<div class="controls">
						<sys:treeselect id="responsibleUnitId" name="responsibleUnitId" value="${affairReportComplaints.responsibleUnitId}" labelName="responsibleUnit" labelValue="${affairReportComplaints.responsibleUnit}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					   value="<fmt:formatDate value="${affairReportComplaints.date}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			<label class="control-label">是否属实：</label>
			<div class="controls">
				<form:select path="isTrue" class="input-xlarge ">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('affair_is_shushi')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="annex" type="files" uploadPath="affair/affairReportComplaints" selectMultiple="true" />
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairReportComplaints:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
