...
<%--			<span class="help-inline"><font color="red">*</font> </span>--%>
	...
	<div class="control-group">
		<label class="control-label">何种体育特长：</label>
		<div class="controls">
	...
	<div class="control-group">
		<label class="control-label">体育技术等级：</label>
		<div class="controls">
			<form:input path="tiyuLevel" htmlEscape="false" class="input-xlarge"/>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="form-actions">
		<shiro:hasPermission name="affair:affairWentiTalent:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
