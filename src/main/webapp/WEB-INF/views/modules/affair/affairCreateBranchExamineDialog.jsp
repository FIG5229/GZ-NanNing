...
<body>
<form:form id="inputForm" modelAttribute="affairCreateBranch" action="${ctx}/affair/affairCreateBranch/examine" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
