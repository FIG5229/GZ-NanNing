                ...
                success:function(data){
                    if(data.success==true && data.result.length==1){
                        ...
                        var submit = function (v, h, f) {
							...
							$("#unitName").val(data.result[f.selected].actualUnitId);
                            return true;
                        };
...
<body>
<br>
	<form:form id="inputForm" modelAttribute="affairTwPersonalAward" action="${ctx}/affair/affairTwPersonalAward/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${affairTwPersonalAward.date}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">获奖时所在单位：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">奖项文号：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="filePath" type="files" uploadPath="affair/affairTwPersonalAward" selectMultiple="true"/>
			</div>
		</div>

		<div class="form-actions">
			<shiro:hasPermission name="affair:affairTwPersonalAward:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
