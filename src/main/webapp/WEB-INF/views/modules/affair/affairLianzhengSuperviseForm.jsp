...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairLianzhengSupervise" action="${ctx}/affair/affairLianzhengSupervise/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="foundDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					   value="<fmt:formatDate value="${affairLianzhengSupervise.foundDate}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="joinPeople" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="zbUnit" name="zbUnitId" value="${affairLianzhengSupervise.zbUnitId}" labelName="zbUnit" labelValue="${affairLianzhengSupervise.zbUnit}"
								title="发布部门" url="/sys/office/treeData?type=2" cssClass="required" allowClear="true" notAllowSelectParent="falsse" dataMsgRequired="必填信息"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="jdUnit" class="input-xlarge ">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="annex" type="files" uploadPath="affair/affairLianzhengSupervise" selectMultiple="true"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairLianzhengSupervise:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
