...
<body>
	<form:form id="inputForm" modelAttribute="affairStandard" action="${ctx}/affair/affairStandard/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
		<form:hidden path="id"/>
