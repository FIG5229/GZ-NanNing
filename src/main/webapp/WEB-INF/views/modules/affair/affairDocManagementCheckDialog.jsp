...
<head>
    ...
    <script type="text/javascript">
        function setCheckType(checkType) {
            if(3== checkType && (null == $("#twoCheckManId").val() || "" ==  $("#twoCheckManId").val())){
                $.jBox.tip('请选择审核单位');
                return false;
            }
...
<body>
<form:form id="inputForm" modelAttribute="affairDocManagement" action="${ctx}/affair/affairDocManagement/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
    ...
    <div class="controls" type="hidden">
        ...
        <sys:treeselect id="twoCheckMan" name="twoCheckId" value="${affairDocManagement.twoCheckId}" labelName="twoCheckMan" labelValue="${affairDocManagement.twoCheckMan}"
                        title="送审单位" url="/sys/office/treeData?type=2" cssClass="" allowClear="true" notAllowSelectParent="true" isAll="true"/>
