...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairJuPartyCongressRepresentative" action="${ctx}/affair/affairJuPartyCongressRepresentative/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${affairJuPartyCongressRepresentative.unitId}" labelName="unit" labelValue="${affairJuPartyCongressRepresentative.unit}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairJuPartyCongressRepresentative:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
