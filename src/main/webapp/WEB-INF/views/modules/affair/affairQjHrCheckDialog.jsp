...
<body>
<form:form id="inputForm" modelAttribute="affairQj" action="${ctx}/affair/affairQj/hrShenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:textarea path="hrOpinion" htmlEscape="false" rows="6" class="input-xxlarge "/>
        </div>
    </div>
