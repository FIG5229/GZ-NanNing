...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairBookCatalog" action="${ctx}/affair/affairBookCatalog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">书目：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="writer" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
