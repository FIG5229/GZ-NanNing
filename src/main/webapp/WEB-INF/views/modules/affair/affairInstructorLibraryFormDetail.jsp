					...
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairInstructorLibrary.name}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${fns:getDictLabel(affairInstructorLibrary.sex, 'sex', '')}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairInstructorLibrary.idNumber}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairInstructorLibrary.job}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairInstructorLibrary.direction}</span>
							</div>
						</div>
					</div>
					...
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairInstructorLibrary.instructorProfile}</span>
							</div>
						</div>
					</div>
					<div>
