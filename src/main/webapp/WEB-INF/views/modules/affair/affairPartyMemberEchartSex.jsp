...
<body>
	<form:form id="searchForm" modelAttribute="affairPartyMember" action="${ctx}/affair/affairPartyMember/echartSexFindPage" method="post">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="affairPartyMember" varStatus="status">
			<tr>
				...
				<td>
					${fns:getDictLabel(affairPartyMember.sex, 'sex', '')}
				</td>
				<td class="handleTd">
