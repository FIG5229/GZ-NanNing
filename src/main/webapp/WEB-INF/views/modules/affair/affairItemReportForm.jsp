...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairItemReport" action="${ctx}/affair/affairItemReport/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${affairItemReport.unitId}" labelName="unit" labelValue="${affairItemReport.unit}"
					title="单位名称" url="/sys/office/treeData?type=2" cssClass="required" allowClear="true" notAllowSelectParent="true" dataMsgRequired="必填信息"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="marriageStatus" class="input-xlarge required">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="hk" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairItemReport:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
