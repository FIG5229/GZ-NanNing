...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/affair/affairDisciplinaryAction/affairDisciplinaryActionListSum">统计汇总</a></li>
...
<form:form id="searchForm" modelAttribute="affairDisciplinaryAction" action="${ctx}/affair/affairDisciplinaryAction/" method="post" class="breadcrumb form-search">
    <ul class="ul-form">
        ...
        <li><label class="width120">违纪问题性质：</label>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tbody>
    <c:forEach items="${page.list}" var="affairDisciplinaryAction">
        <tr>
            <td>
