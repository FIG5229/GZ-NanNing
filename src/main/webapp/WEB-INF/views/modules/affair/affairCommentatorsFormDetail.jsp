		...
		<div class="modal-custom-main">
			<div class="modal-custom-content">
				<div id="contentTable" class="modal-custom-content">
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairCommentators.name}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairCommentators.idNumber}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairCommentators.unit}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairCommentators.duty}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairCommentators.phone}</span>
							</div>
						</div>
					</div>
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row">
								...
								<span class="modal-custom-info2-value">${affairCommentators.description}</span>
							</div>
						</div>
					</div>
					...
					<div class="modal-custom-info2">
						<div class="modal-custom-info2-col modal-custom-info2-col1">
							<div class="modal-custom-info2-row"><span class="modal-custom-info2-key">账号情况：</span>
								<span class="modal-custom-info2-value">
                                    <table>
                                        <c:forEach items="${affairCommentators.affairCommentatorsDeputies}" var="m" varStatus="status">
