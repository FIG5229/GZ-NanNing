...
<body>
<form:form id="inputForm" modelAttribute="affairPartyDayActivities" action="${ctx}/affair/affairPartyDayActivities/examine" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
