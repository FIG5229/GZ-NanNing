...
<body>
<br>
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/saves?type=affairPolicewomanTalent" method="post" class="form-horizontal">
		<%--<form:hidden path="id"/--%>
...
<shiro:hasPermission name="cms:article:audit">
		...
		<div class="form-actions">
			<shiro:hasPermission name="cms:article:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="确定"
