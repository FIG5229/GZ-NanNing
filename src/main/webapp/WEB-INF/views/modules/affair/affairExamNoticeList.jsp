		...
		function openDetailDialog(id,signStatus) {
			...
			top.$.jBox.open(url, "通知通报文件",1000,600,{
				...
				loaded:function(h){
					...
					self.location.href="${ctx}/affair/affairFileNotice?flag=5";
				}
			});
		};
	</script>
...
<ul class="nav nav-tabs">
	<li class="active"><a href="${ctx}/affair/affairFileNotice?flag=5">查询</a></li>
	<shiro:hasPermission name="affair:affairFileNotice:manage5"><li><a href="${ctx}/affair/affairFileNotice/manageList?flag=5">管理</a></li></shiro:hasPermission>
</ul>
...
<form:form id="searchForm" modelAttribute="affairFileNotice" action="${ctx}/affair/affairFileNotice/" method="post" class="breadcrumb form-search">
	...
	<ul class="ul-form2">
		...
		<li class="btns"><input  class="btn btn-primary" type="button" value="重置" onclick="window.location.href='${ctx}/affair/affairFileNotice?flag=5'"/></li>
