...
<form:form id="searchForm" modelAttribute="affairIdeology" action="${ctx}/affair/affairIdeology/manage?flag=1" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        <th>报送时间</th>
        <th>签收时间</th>
        <shiro:hasPermission name="affair:affairIdeology:edit"><th>操作</th></shiro:hasPermission>
    </tr>
    </thead>
    <tbody>
    <c:forEach items="${page.list}" var="affairIdeology" varStatus="status">
        <tr>
            ...
            <shiro:hasPermission name="affair:affairIdeology:edit"><td>
