...
<body>
	<%--<ul class="nav nav-tabs">
		<li><a href="${ctx}/affair/affairOtherPartyRepresentative/">其他党代表会列表</a></li>
		<li class="active"><a href="${ctx}/affair/affairOtherPartyRepresentative/form?id=${affairOtherPartyRepresentative.id}">其他党代表会<shiro:hasPermission name="affair:affairOtherPartyRepresentative:edit">${not empty affairOtherPartyRepresentative.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="affair:affairOtherPartyRepresentative:edit">查看</shiro:lacksPermission></a></li>
	</ul>--%>
	<br/>
	<form:form id="inputForm" modelAttribute="affairOtherPartyRepresentative" action="${ctx}/affair/affairOtherPartyRepresentative/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${affairOtherPartyRepresentative.unitId}" labelName="unit" labelValue="${affairOtherPartyRepresentative.unit}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairOtherPartyRepresentative:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
