...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairComment" action="${ctx}/affair/affairComment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="partyOrganization" name="partyOrganizationId"
								value="${affairComment.partyOrganizationId}" labelName="partyOrganization"
								labelValue="${affairComment.partyOrganization}"
								title="党组织名称" url="/affair/affairGeneralSituation/treeData" cssClass="required"
