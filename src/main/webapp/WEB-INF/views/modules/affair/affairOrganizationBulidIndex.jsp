...
<div id="content" class="row-fluid">
	<div id="left" class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle">工会组织<i class="icon-refresh pull-right" onclick="refreshTree();"></i></a>
		</div>
...
<script type="text/javascript">
	var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:''}},
		callback:{onClick:function(event, treeId, treeNode){
				...
				$('#officeContent').attr("src","${ctx}/affair/affairOrganizationBulid/list?treeId="+id+"&parentIds="+treeNode.pId+"&isTree=1");
			}
		}
	};
