                ...
                <div id="contentTable" class="modal-custom-content">
                    <div class="modal-custom-info2">
                        <div class="modal-custom-info2-col modal-custom-info2-col1">
                            <div class="modal-custom-info2-row"><span class="modal-custom-info2-key">证书：</span><span
                                    class="modal-custom-info2-value">${affairCertificateIssue.certificate}</span></div>
                            <div class="modal-custom-info2-row"><span class="modal-custom-info2-key">颁发途径：</span><span
                                    class="modal-custom-info2-value">${fns:getDictLabel(affairCertificateIssue.way, 'certificate_way', '')}</span></div>
                            <div class="modal-custom-info2-row"><span class="modal-custom-info2-key">说明：</span><span
                                    class="modal-custom-info2-value">${affairCertificateIssue.explain}</span></div>
                            <div class="modal-custom-info2-row"><span class="modal-custom-info2-key">编号：</span><span
                                    class="modal-custom-info2-value">${affairCertificateIssue.number}</span></div>
                            <div class="modal-custom-info2-row"><span class="modal-custom-info2-key">颁发日期：</span><span
                                    ...
                                    value="${affairCertificateIssue.date}" pattern="yyyy-MM-dd"/></span></div>
                        </div>
                    </div>
