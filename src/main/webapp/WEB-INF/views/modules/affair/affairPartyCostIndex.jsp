...
<div id="content" class="row-fluid">
	...
	<div id="right">
		<iframe id="partyCostContent" src="" width="100%" height="91%" frameborder="0"></iframe>
	</div>
</div>
<script type="text/javascript">
	...
	var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:''}},
		callback:{onClick:function(event, treeId, treeNode){
				...
				if (id == '1' || id == '2' || id == '34' || id ==  '95' || id == '156') {
					$('#partyCostContent').attr("src","${ctx}/sys/user/blank");
				}else{
					$('#partyCostContent').attr("src","${ctx}/affair/affairPartyCost/list?treeId="+id+"&year="+${year} + "&month="+ ${month});
				}
				<%--$('#partyCostContent').attr("src","${ctx}/affair/affairPartyCost/list?treeId="+id+"&year="+${year} + "&month="+ ${month});--%>
	...
	function refreshTree(){
		$.getJSON("${ctx}/affair/affairGeneralSituation/treeData",function(data){
			...
			node = tree.getNodeByParam("id","39874381f2ee48879b4da091d19fd7b8");
