...
<script type="text/javascript">
    ...
    function signOne(noticeId) {
        $.ajax({
            type:"post",
            url:"${ctx}/affair/affairLzxxjyActivitiesSign/signOne",
            data:{id:noticeId},
            //dataType:"json",
        ...
        <div class="modal-custom-main">
            <div id="contentTable" class="modal-custom-content">
                <div class="modal-custom-info1">
                    <p style="color:#555555;font-size:14px;text-align:left;border-bottom:1px solid #ddd;padding-bottom:15px;margin:25px 0;">发布部门：${affairLzxxjyActivities.publishDep}</p>
                    ${affairLzxxjyActivities.content}
                </div>
            ...
            <div class="modal-custom-info1-bottom">
                ...
                <shiro:hasPermission name="affair:affairLzxxjyActivitiesSign:edit">
                    <c:if test="${affairLzxxjyActivities.signStatus != '1'}">
                        <div id="signDiv" class="modal-custom-info1-btn red" onclick="signOne('${affairLzxxjyActivities.id}')">签收</div>
                    </c:if>
                </shiro:hasPermission>
