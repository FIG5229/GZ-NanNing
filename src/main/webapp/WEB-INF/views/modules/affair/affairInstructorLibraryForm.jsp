...
<body> <br/>
	<form:form id="inputForm" modelAttribute="affairInstructorLibrary" action="${ctx}/affair/affairInstructorLibrary/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:webuploader input="adjunct" type="files" uploadPath="affair/affairInstructorLibrary" selectMultiple="true"/>
			</div>
		</div>
