...
<body>
<form:form id="inputForm" modelAttribute="affairTwPersonalAward" action="${ctx}/affair/affairTwPersonalAward/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
