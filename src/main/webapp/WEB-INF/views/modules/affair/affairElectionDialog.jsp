...
<body>
	<form:form id="inputForm" modelAttribute="affairElection" action="${ctx}/affair/affairElection/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
		<form:hidden path="id"/>
