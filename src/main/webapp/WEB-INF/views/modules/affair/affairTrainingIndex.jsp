...
<ul class="nav nav-tabs">
    <shiro:hasPermission name="affair:affairTraining:view"><li class="active"><a href="${ctx}/affair/affairTraining/">练兵比武</a></li></shiro:hasPermission>
...
<script type="text/javascript">
	var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
		callback:{onClick:function(event, treeId, treeNode){
				...
				$('#officeContent').attr("src","${ctx}/affair/affairTraining/list?unitId="+treeNode.id+"&unit="+treeNode.name);
			}
		}
	};
