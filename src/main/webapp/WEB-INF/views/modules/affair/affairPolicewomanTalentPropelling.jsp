...
<body>
<br>
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/saves?type=affairPolicewomanWork" method="post" class="form-horizontal">
		<%--<form:hidden path="id"/--%>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">归属栏目:</label>
			<div class="controls"><%--
            	<sys:treeselect id="category" name="category.id" value="${category.id}" labelName="category.name" labelValue="${article.category.name}" checked="true"
                            	title="栏目" url="/cms/category/treeData" module="article" selectScopeModule="true" notAllowSelectRoot="false" notAllowSelectParent="true" cssClass="required"/>&nbsp
				<span>
...
<%--				<input id="category7" type="checkbox" name="categoryIds[]" value="5d7f5d61b84243ddb53ce5c359e6c2f2"><label>政工要闻</label>--%>
...
<shiro:hasPermission name="cms:article:audit">
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairPolicewomanTalent:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="确定"
																onclick="return checkForm();"/>&nbsp;</shiro:hasPermission>
			<!--
