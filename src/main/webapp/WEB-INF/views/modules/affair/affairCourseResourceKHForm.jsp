...
<body>
	...
	<form:form id="inputForm" modelAttribute="affairCourseResource" action="${ctx}/affair/affairCourseResource/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="khTest" class="input-xlarge ">
					<form:option value="${affairCourseResource.khTest}" label=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="premise" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">考试时长（分钟）：</label>
			<div class="controls">
				<form:input path="khTime" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">卷面显示形式：</label>
			<div class="controls">
				<form:select path="khShape" class="input-xlarge ">
					<form:option value="${affairCourseResource.khShape}" label=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="khDegree" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">设置试卷：</label>
			<div class="controls">
				<form:input path="khPaper" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
