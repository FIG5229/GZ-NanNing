...
<body>
<br/>
<form:form id="inputForm" modelAttribute="affairTjRegisterBase" action="${ctx}/affair/affairTjRegisterBase/save" method="post" class="form-horizontal">
	<form:hidden path="id"/>
	...
	<div class="control-group">
		...
		<div class="controls">
			<sys:treeselect id="partyBranch" name="partyBranchId" value="${affairTjRegisterBase.partyBranchId}" labelName="partyBranch" labelValue="${affairTjRegisterBase.partyBranch}"
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="birthday" name="birthday" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
				   value="<fmt:formatDate value="${affairTjRegisterBase.birthday}" pattern="yyyy-MM-dd"/>"
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:input id="date" path="date" htmlEscape="false" class="input-xlarge required"/>
			<span class="help-inline"><font color="red">*</font> </span>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:textarea path="remark" htmlEscape="false" rows="4" class="input-xxlarge required"/>
		</div>
	</div>
	<%--<div align=center>
        <span class="help-inline"><font color="red">*</font> </span>
	...
	<div class="form-actions">
		<shiro:hasPermission name="affair:affairTjRegisterBase:edit"><input id="btnSubmit" class="btn btn-primary" type="button" value="保 存" onclick="save()" />&nbsp;</shiro:hasPermission>
