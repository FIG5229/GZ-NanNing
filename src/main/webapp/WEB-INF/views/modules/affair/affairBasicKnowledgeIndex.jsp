...
<ul class="nav nav-tabs">
	<li class="active"><a href="${ctx}/affair/affairBasicKnowledge">基本知识</a></li>
	...
	<%--		<shiro:hasPermission name="affair:affairBasicKnowledge:edit"><li><a href="${ctx}/affair/affairBasicKnowledge/form">基本知识成绩添加</a></li></shiro:hasPermission>--%>
</ul>
<div id="content" class="row-fluid">
	...
	<div id="right">
		<iframe id="officeContent" src="" width="100%" height="95%" frameborder="0"></iframe>
	</div>
</div>
<script type="text/javascript">
	var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
		callback:{onClick:function(event, treeId, treeNode){
				...
				$('#officeContent').attr("src","${ctx}/affair/affairBasicKnowledge/list?unitId="+treeNode.id+"&unit="+treeNode.name);
			}
		}
	};
