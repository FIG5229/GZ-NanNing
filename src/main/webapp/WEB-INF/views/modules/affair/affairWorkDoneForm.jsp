...
<body>
	 <br/>
	<form:form id="inputForm" modelAttribute="affairWorkDone" action="${ctx}/affair/affairWorkDone/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
			<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">党组织名称：</label>
			<div class="controls">
				<sys:treeselect id="partyOrganization" name="partyOrganizationId" value="${affairWorkDone.partyOrganizationId}" labelName="partyOrganization" labelValue="${affairWorkDone.partyOrganization}"
