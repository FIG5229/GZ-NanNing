...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="affairSjPartyCongressRepresentative" action="${ctx}/affair/affairSjPartyCongressRepresentative/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="unit" name="unitId" value="${affairSjPartyCongressRepresentative.unitId}" labelName="unit" labelValue="${affairSjPartyCongressRepresentative.unit}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairSjPartyCongressRepresentative:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
