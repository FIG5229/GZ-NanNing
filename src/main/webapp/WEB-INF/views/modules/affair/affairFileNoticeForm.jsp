...
<%--<ul class="nav nav-tabs">
    <li><a href="${ctx}/affair/affairFileNotice/">通知通报列表</a></li>
    <li class="active"><a href="${ctx}/affair/affairFileNotice/form?id=${affairFileNotice.id}">通知通报<shiro:hasPermission name="affair:affairFileNotice:manage">${not empty affairFileNotice.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="affair:affairFileNotice:manage">查看</shiro:lacksPermission></a></li>
    <shiro:hasPermission name="affair:affairFileNotice:manage"><li><a href="${ctx}/affair/affairFileNotice/publishList">通知通报管理</a></li></shiro:hasPermission>
</ul>--%>
<br/>
<%--@elvariable id="affairFileNotice" type="com.thinkgem.jeesite.modules.affair.entity.AffairFileNotice"--%>
<form:form id="inputForm" modelAttribute="affairFileNotice" action="${ctx}/affair/affairFileNotice/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
        ...
        <div class="controls">
            <form:select path="type" class="input-xlarge required">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <form:options items="${fns:getDictList('affair_jy_culture_notice_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                    </c:otherwise>
                </c:choose>
            </form:select>
            <span class="help-inline"><font color="red">*</font> </span>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="publishDep" name="publishOrgId" value="${affairFileNotice.publishOrgId}" labelName="publishDep" labelValue="${affairFileNotice.publishDep}"
                title="发布部门" url="/sys/office/treeData?type=2" cssClass="required" allowClear="true" notAllowSelectParent="false" dataMsgRequired="必填信息"/>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="receiveDep" name="receiveDepId" value="${affairFileNotice.receiveDepId}" labelName="receiveDep" labelValue="${affairFileNotice.receiveDep}"
...
<%--    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <sys:ckeditor replace="content" uploadPath="affair/affairFileNotice"/>
        </div>
    </div>
    <%--发布日期暂时用更新日期，不让手填--%>
    <%--<div class="control-group">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="affair:affairFileNotice:manage">
            ...
            <%--
            <shiro:hasPermission name="affair:affairFileNotice:manage4">
