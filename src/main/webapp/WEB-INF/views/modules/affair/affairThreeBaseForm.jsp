...
<body>
<br/>
	<form:form id="inputForm" modelAttribute="affairThreeBase" action="${ctx}/affair/affairThreeBase/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">基本知识：</label>
			<div class="controls">
				<form:input path="basicKnowledge" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基本体能：</label>
			<div class="controls">
				<form:input path="basicFitness" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基本技能：</label>
			<div class="controls">
				<form:input path="baseSkill" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">成绩总评：</label>
			<div class="controls">
<%--				<form:input path="overallScore" htmlEscape="false" class="input-xlarge "/>--%>
				<form:select path="overallScore" class="input-xlarge ">
					<form:option value="" label=""/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairThreeBase:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
