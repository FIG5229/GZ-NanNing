...
<body>
<form:form id="inputForm" modelAttribute="affairMonthStudy" action="${ctx}/affair/affairMonthStudy/examine" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
