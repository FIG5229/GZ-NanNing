...
<body>
	...
	<form:form id="searchForm" modelAttribute="affairPartyMember" action="${ctx}/affair/affairPartyMember/echartWorkPlaceFindPage" method="post">
