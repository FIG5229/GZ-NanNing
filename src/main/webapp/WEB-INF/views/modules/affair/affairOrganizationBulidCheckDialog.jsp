...
<body>
<form:form id="inputForm" modelAttribute="affairOrganizationBulid" action="${ctx}/affair/affairOrganizationBulid/shenHe" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
