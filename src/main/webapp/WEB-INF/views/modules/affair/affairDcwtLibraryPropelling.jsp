...
<body>
<br>
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/saves?type=affairDcwtLibrary" method="post" class="form-horizontal">
		<%--<form:hidden path="id"/--%>
		...
		<div class="control-group">
			...
			<div class="controls"><%--
				...
				<%--更换多选样式--%>
			<%--	<form:select path="categoryArr" class="input-medium" multiple="multiple">
