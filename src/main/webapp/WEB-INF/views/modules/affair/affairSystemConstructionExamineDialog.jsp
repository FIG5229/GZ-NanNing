...
<body>
<form:form id="inputForm" modelAttribute="affairSystemConstruction" action="${ctx}/affair/affairSystemConstruction/examine" method="post" class="form-horizontal" cssStyle="margin-top: 20px;">
    <form:hidden path="id"/>
