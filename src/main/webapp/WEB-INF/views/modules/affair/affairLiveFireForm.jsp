...
<body>
<br/>
	<form:form id="inputForm" modelAttribute="affairLiveFire" action="${ctx}/affair/affairLiveFire/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">枪型：</label>
			<div class="controls">
				<form:input path="gunType" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">十环：</label>
			<div class="controls">
				<form:input path="tenRings" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">九环：</label>
			<div class="controls">
				<form:input path="nineRings" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">八环：</label>
			<div class="controls">
				<form:input path="eightRings" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">七环：</label>
			<div class="controls">
				<form:input path="sevenRings" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">六环：</label>
			<div class="controls">
				<form:input path="sixRings" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">五环：</label>
			<div class="controls">
				<form:input path="fiveRings" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">总环数：</label>
			<div class="controls">
				<form:input path="sumRings" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否合格：</label>
			<div class="controls">
				<form:select path="isQualified" class="input-xlarge ">
					<form:option value="" label=""/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="affair:affairLiveFire:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
