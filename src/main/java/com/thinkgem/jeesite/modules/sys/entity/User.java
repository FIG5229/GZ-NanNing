...
public class User extends DataEntity<User> {
    ...
    @ExcelField(title = "是否允许登录", align = 2, sort = 8, dictType = "yes_no")
    ...
    //@ExcelField(title="ID", type=0, align=2, sort=12)
	public String getId() {
		return id;
	}
	...
	@ExcelField(title="归属公司", align=2, sort=0)
	...
	@ExcelField(title="归属部门", align=2, sort=1)
	...
	@ExcelField(title="备注", align=1, sort=11)
	public String getRemarks() {
		return remarks;
	}

	@Length(min=0, max=100, message="用户类型长度必须介于 1 和 100 之间")
    @ExcelField(title = "用户类型", align = 2, sort = 9, dictType = "sys_user_type")
    ...
    //@ExcelField(title="创建时间", type=0, align=1, sort=10)
	...
	@JsonIgnore
	@ExcelField(title="拥有角色", align=1, sort=10, fieldType=RoleListType.class)
	...
	public String getBaseOfficeName() {
		return baseOfficeName;
	}

	public void setBaseOfficeName(String baseOfficeName) {
		this.baseOfficeName = baseOfficeName;
	}
