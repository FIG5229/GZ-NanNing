 ...
 * @version 2020-07-09
 */
public class PersonnelPoliceFamilyTwo extends DataEntity<PersonnelPoliceFamilyTwo> {
	...
	public PersonnelPoliceFamilyTwo() {
		super();
	}

	public PersonnelPoliceFamilyTwo(String id){
		super(id);
	}
