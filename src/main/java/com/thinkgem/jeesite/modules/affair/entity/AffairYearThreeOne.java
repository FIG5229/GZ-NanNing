...
/**
 * &ldquo;三会一课&rdquo;录入Entity
 * @author eav.liu
 * @version 2019-11-08
 */
public class AffairYearThreeOne extends DataEntity<AffairYearThreeOne> {
	...
	private String addStatus;		// 添加时状态
	...
	private String person2Id;		//已会人员
	private String person3Id;		//未会人员


	public AffairYearThreeOne() {
		super();
	}

	public AffairYearThreeOne(String id){
		super(id);
	}
