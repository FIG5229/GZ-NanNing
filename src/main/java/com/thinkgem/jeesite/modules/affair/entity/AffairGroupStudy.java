 ...
 * @version 2019-11-04
 */
public class AffairGroupStudy extends DataEntity<AffairGroupStudy> {
	
	private static final long serialVersionUID = 1L;
	@ExcelField(title = "学习内容", type = 0, align = 2, sort = 1)
	...
	@ExcelField(title = "学习地点", type = 0, align = 2, sort = 4)
	private String place;		// 学习地点
	@ExcelField(title = "学习形式", type = 0, align = 2, sort = 3, dictType="affair_study_type")
...
//	@EsAttach
	...
	public AffairGroupStudy() {
		super();
	}

	public AffairGroupStudy(String id){
		super(id);
	}
