 ...
 * @version 2020-06-09
 */
public class AffairChuPartyCongressRepresentative extends DataEntity<AffairChuPartyCongressRepresentative> {
	...
	public AffairChuPartyCongressRepresentative() {
		super();
	}

	public AffairChuPartyCongressRepresentative(String id){
		super(id);
	}
