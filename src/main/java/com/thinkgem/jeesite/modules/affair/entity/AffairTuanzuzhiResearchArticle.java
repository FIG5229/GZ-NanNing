 ...
 * @version 2019-11-07
 */
public class AffairTuanzuzhiResearchArticle extends DataEntity<AffairTuanzuzhiResearchArticle> {
	...
	public AffairTuanzuzhiResearchArticle() {
		super();
	}

	public AffairTuanzuzhiResearchArticle(String id){
		super(id);
	}
