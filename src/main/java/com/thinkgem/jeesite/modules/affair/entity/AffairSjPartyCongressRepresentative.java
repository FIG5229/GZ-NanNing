 ...
 * @version 2020-06-09
 */
public class AffairSjPartyCongressRepresentative extends DataEntity<AffairSjPartyCongressRepresentative> {
	...
	public AffairSjPartyCongressRepresentative() {
		super();
	}

	public AffairSjPartyCongressRepresentative(String id){
		super(id);
	}
