 ...
 * @version 2019-11-07
 */
public class AffairTixieConstitutionalSystem extends DataEntity<AffairTixieConstitutionalSystem> {
	
	private static final long serialVersionUID = 1L;
	@ExcelField(title = "标题", type = 0, align = 2, sort = 0)
	private String title;		// 标题
	@ExcelField(title = "单位", type = 0, align = 2, sort = 1,dictType = "affair_tixie_unit")
	...
	private String ownGroupOrganizationId;		// 所属组织id

	private Date startDate;
	private Date endDate;
	
	public AffairTixieConstitutionalSystem() {
		super();
	}

	public AffairTixieConstitutionalSystem(String id){
		super(id);
	}
