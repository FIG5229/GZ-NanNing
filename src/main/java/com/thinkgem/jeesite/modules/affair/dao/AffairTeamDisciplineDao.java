 ...
 */
@MyBatisDao
public interface AffairTeamDisciplineDao extends CrudDao<AffairTeamDiscipline> {
    ...
    int findSignNum(@Param(value = "affairTeamDiscipline") AffairTeamDiscipline affairTeamDiscipline);

    int findSumNum(@Param(value = "affairTeamDiscipline") AffairTeamDiscipline affairTeamDiscipline);

    List<AffairTeamDiscipline> findByIds(@Param(value = "ids") List<String> ids);

    List<AffairTeamDiscipline> indexNoticeList();
}