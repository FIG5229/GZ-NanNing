 ...
 * @version 2019-11-29
 */
public class AffairWentiTalent extends DataEntity<AffairWentiTalent> {
	...
	@ExcelField(title = "何种体育特长", type = 0, align = 2, sort = 7)
	private String skill;		// 何种体育特长
	@ExcelField(title = "体育等级", type = 0, align = 2, sort = 8)
	private String tiyuLevel;		// 何种特长
	...
	public AffairWentiTalent() {
		super();
	}

	public AffairWentiTalent(String id){
		super(id);
	}
	...
	public String getTiyuLevel() {
		return tiyuLevel;
	}

	public void setTiyuLevel(String tiyuLevel) {
		this.tiyuLevel = tiyuLevel;
	}
}