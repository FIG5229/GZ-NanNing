 ...
 * @version 2020-08-03
 */
public class AffairNetworkCollegeYear extends DataEntity<AffairNetworkCollegeYear> {
	...
	public AffairNetworkCollegeYear() {
		super();
	}

	public AffairNetworkCollegeYear(String id){
		super(id);
	}
