 ...
 * @version 2020-06-05
 */
public class AffairDeclarationTrivingExcellence extends DataEntity<AffairDeclarationTrivingExcellence> {
	...
	public AffairDeclarationTrivingExcellence() {
		super();
	}

	public AffairDeclarationTrivingExcellence(String id){
		super(id);
	}
