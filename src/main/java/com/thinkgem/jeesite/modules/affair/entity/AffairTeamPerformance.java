 ...
 * @version 2020-12-29
 */
public class AffairTeamPerformance extends DataEntity<AffairTeamPerformance> {
...
//	@ExcelField(title = "序号", type = 0, align = 2, sort = 0)
	...
	@ExcelField(title = "比武结束时间", type = 0, align = 2, sort = 1)
	private Date finishDate;  // 比武结束时间
	@ExcelField(title = "比武名称", type = 0, align = 2, sort = 2)
	private String name;  // 比武名称
	...
	@ExcelField(title = "总成绩", type = 0, align = 2, sort = 10)
	private String score;		// 总成绩
	@ExcelField(title = "排名", type = 0, align = 2, sort = 11)
	...
	public AffairTeamPerformance() {
		super();
	}

	public AffairTeamPerformance(String id){
		super(id);
	}
