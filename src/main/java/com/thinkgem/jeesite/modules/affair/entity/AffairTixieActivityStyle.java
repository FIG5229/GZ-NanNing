 ...
 * @version 2019-11-07
 */
public class AffairTixieActivityStyle extends DataEntity<AffairTixieActivityStyle> {
	
	private static final long serialVersionUID = 1L;
	@ExcelField(title = "标题", type = 0, align = 2, sort = 0)
	private String title;		// 标题
	@ExcelField(title = "类别", type = 0, align = 2, sort = 1, dictType="affair_txhuodong")
	...
	public AffairTixieActivityStyle() {
		super();
	}

	public AffairTixieActivityStyle(String id){
		super(id);
	}
