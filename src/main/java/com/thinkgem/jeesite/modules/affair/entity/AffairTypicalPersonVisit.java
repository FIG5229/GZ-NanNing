 ...
 * @version 2020-07-31
 */
public class AffairTypicalPersonVisit extends DataEntity<AffairTypicalPersonVisit> {
	...
	private String typicalPersonId;		// 典型个人表主键

	public AffairTypicalPersonVisit() {
		super();
	}

	public AffairTypicalPersonVisit(String id){
		super(id);
	}
