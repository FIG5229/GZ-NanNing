 ...
 * @version 2020-06-16
 */
public class AffairTeamDisciplineSign extends DataEntity<AffairTeamDisciplineSign> {
	...
	public AffairTeamDisciplineSign() {
		super();
	}

	public AffairTeamDisciplineSign(String id){
		super(id);
	}
