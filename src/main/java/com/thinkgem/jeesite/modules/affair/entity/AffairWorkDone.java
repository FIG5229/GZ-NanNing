 ...
 * @version 2020-05-29
 */
public class AffairWorkDone extends DataEntity<AffairWorkDone> {
	...
	public AffairWorkDone() {
		super();
	}

	public AffairWorkDone(String id){
		super(id);
	}
	...
	public String getAdjunct() {return adjunct;	}

	public void setAdjunct(String adjunct) {this.adjunct = adjunct;}
