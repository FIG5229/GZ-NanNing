...
public class Page<T> {
	...
	public String toString() {
		...
		long endNo = pageNo*pageSize;
		if(endNo > count){
			endNo = count;
		}
		sb.append("<li class=\"disabled controls\"><a href=\"javascript:\">当前 ");
//		sb.append("<input type=\"text\" value=\""+startNo+"\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/> / ");
//		sb.append("<input type=\"text\" value=\""+endNo+"\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> 条，");
		sb.append(startNo+"-"+endNo+"条，");
